...
$(CBS_BIN): $(BUILD_DIR)/cbs_main.o $(BUILD_DIR)/cbs_args.o $(BUILD_DIR)/bin_gc.o $(BUILD_DIR)/raw_counts_loader.o $(BUILD_DIR)/cell_filter.o $(BUILD_DIR)/lowess.o $(BUILD_DIR)/gc_correct.o
	$(CXX) $^ -o $@ -lz
