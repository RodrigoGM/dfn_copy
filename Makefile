...
$(CBS_BIN): $(BUILD_DIR)/cbs_main.o $(BUILD_DIR)/cbs_args.o $(BUILD_DIR)/bin_gc.o $(BUILD_DIR)/raw_counts_loader.o $(BUILD_DIR)/cell_filter.o $(BUILD_DIR)/lowess.o $(BUILD_DIR)/gc_correct.o $(BUILD_DIR)/vendor_stats.o $(BUILD_DIR)/vendor_correction.o $(BUILD_DIR)/vendor_cbs.o
	$(CXX) $^ -o $@ -lz
