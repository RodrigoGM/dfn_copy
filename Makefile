...
$(CBS_BIN): $(BUILD_DIR)/cbs_main.o $(BUILD_DIR)/cbs_args.o $(BUILD_DIR)/bin_gc.o \
            ...
            $(BUILD_DIR)/transpose_writer.o $(BUILD_DIR)/progress_reporter.o
	$(CXX) $^ -o $@ -lz -pthread
